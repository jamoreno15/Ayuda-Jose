 ...
 * @author JavaMasters
 */
public class FrmPrincipalMenuUser extends javax.swing.JFrame {

    Background screen = new Background();

    public FrmPrincipalMenuUser() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPrincipalMenuUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
